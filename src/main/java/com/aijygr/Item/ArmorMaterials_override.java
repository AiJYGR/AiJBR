...
public enum ArmorMaterials_override implements StringRepresentable, ArmorMaterial {
    LEATHER("leather", 5, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266652_) -> {
     ...
     CHAIN("chainmail", 15, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266651_) -> {
        p_266651_.put(ArmorItem.Type.BOOTS, 0);
        p_266651_.put(ArmorItem.Type.LEGGINGS, 0);
        p_266651_.put(ArmorItem.Type.CHESTPLATE, 0);
        p_266651_.put(ArmorItem.Type.HELMET, 0);
     ...
     TURTLE("turtle", 25, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266656_) -> {
        p_266656_.put(ArmorItem.Type.BOOTS, 0);
        p_266656_.put(ArmorItem.Type.LEGGINGS, 0);
        p_266656_.put(ArmorItem.Type.CHESTPLATE, 0);
    ...
    public static final StringRepresentable.EnumCodec<ArmorMaterials_override> CODEC = StringRepresentable
            .fromEnum(ArmorMaterials_override::values);
    ...
    private ArmorMaterials_override(String p_268171_, int p_268303_, EnumMap<ArmorItem.Type, Integer> p_267941_,
